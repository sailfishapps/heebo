...
var code_license =
    "All the source code and game level maps for Heebo are licensed under GPLv3.<br/><br/>The source code can be downloaded from <a href=\"http://gitorious.org/heebo\">http://gitorious.org/heebo</a><br/><br/>"+
